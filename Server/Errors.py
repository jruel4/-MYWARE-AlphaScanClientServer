...
class CommunicationErrors:
    ...
    def ERR_BAD_OPCODE(self, opcode="(NOT PROVIDED)", msg=""):
        ''' Opcode unrecognized '''
        name = inspect.currentframe().f_code.co_name
    ...
    def ERR_BAD_NUM_PARAMS(self, expected = "(NOT PROVIDED)", received = "(NOT PROVIDED)", msg=""):
    ...
    def ERR_BAD_PARAM_TYPES(self, msg=""):
    ...
    def ERR_WHEN_CONNECTING(self, msg=""):
    ...
    def ERR_STILL_STREAMING(self, msg=""):
    ...
    def ERR_NOT_STREAMING(self, msg=""):
    ...
    def ERR_ALREADY_CONNECTED(self, msg=""):
    ...
    def ERR_NOT_CONNECTED(self, msg=""):
